namespace MeshModifiers
{
	public class MeshModifierConstants
	{
		...
		public const string
			...
			MODIFY_FRAMES_TOOLTIP = "The number of frames that the modification calculations are performed over. The higher this value goes, the faster the program will run; at the cost of visual fidelity. This has diminishing returns.";
